...
```text
/imagine prompt: A commercial render of image and video playlist items advancing in order on a compatible Android display. Include a simple loop indicator, but do not depict scheduling, failover, or an invented app interface. Leave clear space for headline text. --ar 16:9 --v 6.1 --style raw
```
