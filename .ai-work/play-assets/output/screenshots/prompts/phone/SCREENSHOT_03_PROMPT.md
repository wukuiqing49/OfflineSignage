...
```text
/imagine prompt: A commercial render of a display in a modern retail boutique. The screen shows a video, a seasonal image, and scrolling text. Keep the text legible and leave clean space for a headline overlay. --ar 9:16 --v 6.1 --style raw
```
