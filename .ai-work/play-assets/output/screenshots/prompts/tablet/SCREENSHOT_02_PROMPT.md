# TABLET_SCREENSHOT_02_PROMPT

- Source Brief: `SCREENSHOT_BRIEF.md`
- Asset Type: Tablet Screenshot 02
...
A commercial 3D render of a modern workspace with a sleek laptop and smartphone in the foreground showing the LocalSignage drag-and-drop web console interface with BRAND-ICON-01. In the soft blurred background, a wall display updates its promotional poster over local Wi-Fi. Clean uncluttered upper section for overlay text. Ultra-clean 3D render, minimalist tech workspace, glowing emerald green (#1A8754) Wi-Fi connection beam, photorealistic studio lighting.
```
...
```text
/imagine prompt: A commercial 3D render of a modern workspace with a sleek laptop and smartphone in the foreground showing the LocalSignage drag-and-drop web console interface with BRAND-ICON-01. In the soft blurred background, a wall display updates its promotional poster over local Wi-Fi. Clean uncluttered upper section for overlay text. Ultra-clean 3D render, minimalist tech workspace, glowing emerald green (#1A8754) Wi-Fi connection beam, photorealistic studio lighting. --ar 16:10 --v 6.1 --style raw
```
