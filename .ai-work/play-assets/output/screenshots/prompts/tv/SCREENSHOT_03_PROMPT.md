# TV_SCREENSHOT_03_PROMPT

- Source Brief: `SCREENSHOT_BRIEF.md`
- Asset Type: TV Screenshot 03
...
```text
/imagine prompt: A commercial render of a display in a modern retail boutique. The screen shows a video, a seasonal image, and scrolling text. Keep the text legible and leave clean space for a headline overlay. --ar 16:9 --v 6.1 --style raw
```
