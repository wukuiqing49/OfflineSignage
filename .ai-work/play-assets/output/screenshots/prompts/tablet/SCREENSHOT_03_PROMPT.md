# TABLET_SCREENSHOT_03_PROMPT

- Source Brief: `SCREENSHOT_BRIEF.md`
- Asset Type: Tablet Screenshot 03
...
```text
/imagine prompt: A commercial render of a display in a modern retail boutique. The screen shows a video, a seasonal image, and scrolling text. Keep the text legible and leave clean space for a headline overlay. --ar 16:10 --v 6.1 --style raw
```

---

## 📐 Figma / PS Copy Overlay Card (Ready to Copy-Paste)
- **Main Headline (EN)**: `Videos, Images & Scrolling Text` (Font: Inter / Roboto Bold, ~64-72pt)
